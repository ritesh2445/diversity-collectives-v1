          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3.5">
                ...
                <h1 className="font-display text-4xl sm:text-6xl md:text-7xl xl:text-[5rem] font-extrabold tracking-tight text-slate-950 leading-[1.05]">
                ...
                <p className="text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed max-w-2xl pt-1">
